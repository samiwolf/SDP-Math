...
class Pendulum(pygame.sprite.Sprite):
    ...
    def grab(self, mouse_pos):
        ...
        print
        "Grabbed the bob a vector from center (%d,%d)" % (self.lever_x, self.lever_y)
...
def run():
    ...
    p1 = Pendulum(pivot_vect=SCREEN_CENTER, length=200, bob_radius=50, bob_mass=1, init_angle=pi / 5)
